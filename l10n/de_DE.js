OC.L10N.register(
    ...
    "Web push settings" : "Web-Push-Einstellungen",
    "Web push is a push notification system that lets web applications send notifications to users´ mobile apps or browser, even when the app is not open in a tab." : "Web Push ist ein Push-Benachrichtigungssystem, mit dem Webanwendungen Benachrichtigungen an die mobilen Apps oder den Browser der Benutzer senden können, auch wenn die App nicht in einem Tab geöffnet ist.",
    "Web push notifications are encrypted but routed through services provided by Mozilla, Microsoft, Apple, Google or user-choosen ones in case of mobile apps. While the content is protected, metadata such as timing and frequency of notifications may be exposed to these providers." : "Web-Push-Benachrichtigungen werden verschlüsselt, bei mobilen Apps jedoch über Dienste von Mozilla, Microsoft, Apple, Google oder vom Benutzer ausgewählten Diensten weitergeleitet. Während der Inhalt geschützt ist, können Metadaten wie Zeitpunkt und Häufigkeit der Benachrichtigungen diesen Anbietern bekannt werden.",
    "Allow web push to be used" : "Die Verwendung von Web-Push zulassen",
    "Allow web push for browsers" : "Web-Push für Browser zulassen",
    "None" : "Keine",
