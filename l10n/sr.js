OC.L10N.register(
    "notifications",
    {
    "We want to keep offering our push notification service for free, but large number of users overload our infrastructure. For this reason we have to rate-limit the use of push notifications. If you need this feature, consider using Nextcloud Enterprise." : "Желимо да наставимо са бесплатним пружањем услуге брзих обавештења, али велики број корисника преоптерећује нашу инфраструктуру. Из тог разлога морамо да ограничимо учесталост употребе брзих обавештења. Ако вам је ова функционалност потребна. размислите о преласку на Nextcloud Enterprise.",
    "User not found" : "Корисник није нађен",
    "An unexpected error occurred, ask your administration to check the logs." : "Дошло је до неочекиване грешке, затражите од администрације да  погледа дневнике.",
    "Hello %s" : "Здраво %s",
    "Hello %s," : "Поштовање %s,",
    ...
    "Configure the default notification settings" : "Конфигурисање подразумеваних подешавања обавештења",
