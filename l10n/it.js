OC.L10N.register(
    "notifications",
    {
    "We want to keep offering our push notification service for free, but large users overload our infrastructure. For this reason we have to rate-limit the use of push notifications. If you need this feature, consider using Nextcloud Enterprise." : "Vogliamo continuare a offrire gratuitamente il nostro servizio di notifiche push, ma i grandi utenti sovraccaricano la nostra infrastruttura e per questo motivo dobbiamo limitare l'uso delle notifiche push. Se hai bisogno di questa funzionalità considera l'utilizzo di Nextcloud Enterprise.",
