OC.L10N.register(
    ...
    "_You have a new notification for %s_::_You have %n new notifications for %s_" : ["Du hast eine neue Benachrichtigungen für %s","%n neue Benachrichtigungen für %s"],
    "You can change the frequency of these emails or disable them in the <a href=\"%s\">settings</a>." : "In den  <a href=\"%s\">Einstellungen</a> kann die Häufigkeit dieser E-Mails geändern oder sie deaktivieren werden.",
    "You can change the frequency of these emails or disable them in the settings: %s" : "In den Einstellungen kann die Häufigkeit dieser E-Mails geändert oder sie deaktivieren werden: %s",
    "Admin notifications" : "Administration-Benachrichtigungen",
    ...
    "Configure the default notification settings for new users" : "Standardbenachrichtigungseinstellungen für neue Benutzer konfigurieren",
    ...
    "Play sound when a new notification arrives" : "Ton beim Eintreffen einer neuen Benachrichtigung abspielen",
