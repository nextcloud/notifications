OC.L10N.register(
    ...
    "_You have a new notification for %s_::_You have %n new notifications for %s_" : ["Du hast eine neue Benachrichtigung für %s","Du hast %n neue Benachrichtigungen für %s"],
    ...
    "Dismiss" : "Verwerfen",
    "Contact Nextcloud GmbH" : "Die Nextcloud GmbH kontaktieren",
    "in {path}" : "in {path}",
