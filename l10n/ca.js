OC.L10N.register(
    ...
    "This app provides a backend and frontend for the notification API available in Nextcloud.\n\t\tThe API is used by other apps to notify users in the web UI and sync clients about various things. Some examples are:\n\n📬 Federated file sharing: You received a new remote share\n\n📑 Comments: Another user mentioned you in a comment on a file\n\n🚢 Update notification: Available update for an app or nextcloud itself\n\n📣 Announcement center: An announcement was posted by an admin" : "Aquest aplicació proporciona un rerefons i un frontal per a l’API de notificacions disponible al Nextcloud.\n\t\tL'API l'utilitzen altres aplicacions per notificar als usuaris de la interfície web i als clients de sincronització sobre diversos aspectes. Per exemple:\n\n📬Compartició de fitxers federats: rebeu una nova compartició remota.\n\n📑Comentaris: un altre usuari us ha esmentat en un comentari en un fitxer.\n\n🚢 Notificació d'actualització: hi ha una actualització disponible per a una aplicació o per al Nextcloud.\n\n📣Centre d’anuncis: un administrador ha publicat un anunci.",
    "Dismiss all notifications" : "Descarta totes les notificacions",
    "Requesting browser permissions to show notifications" : "S'està demanant permís al navegador web per mostrar notificacions",
