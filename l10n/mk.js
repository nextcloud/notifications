OC.L10N.register(
    ...
    "Push notifications - Fair use policy" : "Push известувања - Политика за фер користење",
    "Nextcloud GmbH sponsors a free push notification gateway for private users. To ensure good service, the gateway limits the number of push notifications per server and the limit was reached for this server. For enterprise users, a more scalable gateway is available." : "Nextcloud GmbH спонзорира бесплатен портал за Push известувања за приватни корисници. За да обезбеди добра услуга, портата го ограничува бројот на Push известувања по сервер и границата е достигната за овој сервер. За enterprise корисниците, достапен е поскалабилен портал.",
    ...
    "Configure the default notification settings" : "Конфигурирај ги стандардните параметри за известувања",
