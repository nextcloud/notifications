OC.L10N.register(
    "notifications",
    {
    "We want to keep offering our push notification service for free, but large users overload our infrastructure. For this reason we have to rate-limit the use of push notifications. If you need this feature, consider using Nextcloud Enterprise." : "Queremos seguir ofrecendo o noso servizo de notificacións emerxentes de xeito gratuíto, mais os grandes usuarios sobrecargan a nosa infraestrutura. Por este motivo, temos que limitar o uso das notificacións emerxentes. Se necesita esta función, considere usar Nextcloud Enterprise.",
