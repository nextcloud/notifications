OC.L10N.register(
    "notifications",
    {
    "We want to keep offering our push notification service for free, but large number of users overload our infrastructure. For this reason we have to rate-limit the use of push notifications. If you need this feature, consider using Nextcloud Enterprise." : "بىز داۋاملىق ھەقسىز ئۇقتۇرۇش مۇلازىمىتى بىلەن تەمىنلەشنى ئۈمىد قىلىمىز، ئەمما نۇرغۇن ئىشلەتكۈچىلەر ئۇل ئەسلىھەلىرىمىزنى ئارتۇق يۈكلەيدۇ. شۇڭلاشقا، ئۇقتۇرۇش ئىشلىتىش نىسبىتىنى چەكلەشىمىز كېرەك. ئەگەر بۇ ئىقتىدارغا ئېھتىياجلىق بولسىڭىز، Nextcloud Enterprise نى ئىشلىتىشنى ئويلىشىڭىز كېرەك.",
    "User not found" : "ئىشلەتكۈچى تېپىلمىدى",
    "An unexpected error occurred, ask your administration to check the logs." : "كۈتۈلمىگەن خاتالىق يۈز بەردى، باشقۇرۇغۇچىدىن خاتىرىلەرنى تەكشۈرۈشنى تەلەپ قىلىڭ.",
    "Hello %s" : "ياخشىمۇسىز%s",
    "Hello %s," : "ياخشىمۇسىز%s,",
    "_New notification for %s_::_%n new notifications for %s_" : ["%s ھەققىدە يېڭى ئۇقتۇرۇش","%s ھەققىدە %n يېڭى ئۇقتۇرۇش"],
    "_You have a new notification for %s_::_You have %n new notifications for %s_" : ["سىزنىڭ %s توغۇرلۇق بىر يېڭى ئۇقتۇرۇشىڭىز بار","سىزنىڭ %s توغۇرلۇق %n يېڭى ئۇقتۇرۇشىڭىز بار"],
    ...
    "Configure the default notification settings" : "سۈكۈتتىكى ئۇقتۇرۇش تەڭشىكىنى سەپلەڭ",
