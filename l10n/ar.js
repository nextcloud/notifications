OC.L10N.register(
    "notifications",
    {
    "We want to keep offering our push notification service for free, but large users overload our infrastructure. For this reason we have to rate-limit the use of push notifications. If you need this feature, consider using Nextcloud Enterprise." : "كان بودّنا أن نستمر في تقديم خدمة الإشعارات الفورية مجاناً، ولكن المستخدمين الكبار يرهقون بنيتنا الأساسية. ولهذا السبب يتعين علينا تحديد معدل استخدام للإشعارات الفورية. إذا كنت بحاجة إلى هذه الميزة، ففكر في استخدام Nextcloud Enterprise.",
