OC.L10N.register(
    "notifications",
    {
    "We want to keep offering our push notification service for free, but large number of users overload our infrastructure. For this reason we have to rate-limit the use of push notifications. If you need this feature, consider using Nextcloud Enterprise." : "Našu službu upozornení push chceme aj naďalej ponúkať bezplatne, no veľký počet používateľov preťažuje našu infraštruktúru. Z tohto dôvodu musíme obmedziť používanie upozornení push. Ak potrebujete túto funkciu, zvážte použitie Nextcloud Enterprise.",
    "User not found" : "Užívateľ nebol nájdený",
    "An unexpected error occurred, ask your administration to check the logs." : "Vyskytla sa neočakávaná chyba, požiadajte svoju administratívu o kontrolu logov.",
    "Hello %s" : "Ahoj %s",
    "Hello %s," : "Ahoj %s,",
    ...
    "Web push settings" : "Nastavenia webových push notifikácií",
    "Web push is a push notification system that lets web applications send notifications to users´ mobile apps or browser, even when the app is not open in a tab." : "Web push je systém push notifikácií, ktorý umožňuje webovým aplikáciám posielať upozornenia do mobilných aplikácií alebo prehliadača používateľov, aj keď aplikácia nie je otvorená v karte.",
    "Web push notifications are encrypted but routed through services provided by Mozilla, Microsoft, Apple, Google or user-choosen ones in case of mobile apps. While the content is protected, metadata such as timing and frequency of notifications may be exposed to these providers." : "Webové push notifikácie sú šifrované, ale smerujú sa cez služby poskytované spoločnosťami Mozilla, Microsoft, Apple, Google alebo cez služby vybrané používateľom v prípade mobilných aplikácií. Hoci je obsah chránený, metadáta, ako napríklad načasovanie a frekvencia notifikácií, môžu byť týmto poskytovateľom zverejnené.",
    "Allow web push to be used" : "Povoliť používanie webových push notifikácií",
    "Allow web push for browsers" : "Povoliť webové push notifikácie pre prehliadače",
    "None" : "Žiadne",
