OC.L10N.register(
    ...
    "Hello %s" : "ສະບາຍດີ 1%s",
    "Hello %s," : "ສະບາຍດີ 1%s ,",
    "_New notification for %s_::_%n new notifications for %s_" : ["%n new notifications for %s"],
    "_You have a new notification for %s_::_You have %n new notifications for %s_" : ["You have %n new notifications for %s"],
