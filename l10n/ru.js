OC.L10N.register(
    "notifications",
    {
    "We want to keep offering our push notification service for free, but large number of users overload our infrastructure. For this reason we have to rate-limit the use of push notifications. If you need this feature, consider using Nextcloud Enterprise." : "Мы хотим продолжать предлагать нашу услугу push-уведомлений бесплатно, но большое количество пользователей перегружает нашу инфраструктуру. По этой причине мы должны ограничить использование push-уведомлений. Если вам нужна эта функция, рассмотрите возможность использования Nextcloud Enterprise.",
    ...
    "Hello %s," : "Здравствуйте, %s,",
    "_New notification for %s_::_%n new notifications for %s_" : ["Новое уведомление %s","%n новых уведомления  %s","%n новых уведомления  %s","%n новых уведомления  %s"],
    "_You have a new notification for %s_::_You have %n new notifications for %s_" : ["Новое уведомление от %s","У вас %n новых уведомления от %s","У вас %n новых уведомлений от %s","У вас %n новых уведомлений от %s"],
    ...
    "in {path}" : "в {path}",
    "Push notifications might be unreliable" : "Пуш-уведомления могут работать ненадёжно",
    "Nextcloud GmbH sponsors a free push notification gateway for private users. To ensure good service, the gateway limits the number of push notifications per server. For enterprise users, a more scalable gateway is available. Contact Nextcloud GmbH for more information." : "Компания Nextcloud GmbH является спонсором бесплатного шлюза пуш-уведомлений для частных пользователей. Количество пуш-уведомлений, отправляемых через этот шлюз серверами, ограничено. Корпоративным пользователям предлагается использовать более производительный шлюз. Для получения  дополнительной информации, обратитесь в компанию Nextcloud GmbH.",
